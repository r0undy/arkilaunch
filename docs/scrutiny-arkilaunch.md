...
| FC-7 | Cost | Open-Meteo is free for this system's use | Contradicted as stated (free tier is non-commercial, up to 10k calls/day, CC BY 4.0; ArkiLaunch is commercial and needs a paid plan). **Addendum (2026-08-20, `cr-arkilaunch-open-meteo-free-tier.md`): the finding is not overturned -- the project accepts the free tier for the pilot anyway, in writing, with the non-commercial-use exposure carried forward under G-4 rather than resolved.** | [Open-Meteo pricing/about](https://open-meteo.com/en/about) | Significant |
