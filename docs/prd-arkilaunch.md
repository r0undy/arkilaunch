...
| M5 | Deployment / Rollout (anchor pilot) | QA signed off | Almara live on core modules; smoke tests green; observability + alerts wired; rollback rehearsed | Production release (anchor tenant) | M4 | ArkiLaunch eng lead | diesel source unresolved (Open-Meteo resolved 2026-08-20 to the free tier, `cr-arkilaunch-open-meteo-free-tier.md`; its non-commercial-use restriction stays open as SCRUTINY G-4) |
