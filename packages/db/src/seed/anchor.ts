...
async function main() {
  ...
  const FLEET_PLAN: { type: string; model: string; serial: string; status: string; hours: string }[] = [
    ...
    { type: 'Boom Lift (Manlift)', model: 'Genie S-60', serial: 'almara-serial-006', status: 'deployed', hours: '540.00' },
    { type: 'Boom Lift (Manlift)', model: 'JLG 660SJ', serial: 'almara-serial-007', status: 'available', hours: '120.50' },
    { type: 'Wheel Loader (Payloader)', model: 'Komatsu WA200', serial: 'almara-serial-008', status: 'available', hours: '2015.00' },
    { type: 'Wheel Loader (Payloader)', model: 'CAT 950M', serial: 'almara-serial-009', status: 'deployed', hours: '1690.25' },
    ...
    { type: 'Wheel Loader (Payloader)', model: 'Volvo L60H', serial: 'almara-serial-019', status: 'available', hours: '1580.50' },
    { type: 'Boom Lift (Manlift)', model: 'Skyjack SJ86', serial: 'almara-serial-020', status: 'available', hours: '410.00' },
